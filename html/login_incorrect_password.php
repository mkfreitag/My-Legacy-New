...
<!--NEW CODE BEGIN-->
                    ...
                    <div class="animate-box center">
                        <div>
                            <h4 style="color: red;" class="fh5co-top-logo">*Incorrect Username or Password</h4>
                        </div>
						<form name="loginform" method="post" action="checklogin.php">
							<div class="row form-group">
								<div class="col-md-12">
									<label for="email">Email</label>
									<input style="box-shadow:0 0 5px 1px red;" name="myusername" type="text" id="myusername" class="form-control" placeholder="Enter Email">
                                </div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input style="box-shadow:0 0 5px 1px red;" name="mypassword" type="password" id="mypassword" class="form-control" placeholder="Enter Password">
                                </div>
							</div>
                            ...
                            <div>
                                <span class="psw">Forgot <a href="password_recover_in.php">password?</a></span>
                            </div>
						</form>		
					</div>
