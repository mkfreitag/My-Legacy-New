		...
		<div class="container">
            ...
            <div class="form-group">
                ...
                <form action="upload.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="file" name="filetoupload" class="btn btn-primary btn-outline" />
                    <button type="submit" name="iwanttoupload" class="btn btn-primary btn-outline">Upload</button>
