	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="fh5co-top-logo">
				<div id="fh5co-logo"><a href="#">My Legacy
                <?php
...
-->
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<a class="work" href="media.php">
						<div class="work-grid" style="background-image:url(images/video.jpg);">
							<div class="inner">
								<div class="desc">
								<h3>Videos</h3>
								<span class="cat"></span>
				...
				<div class="col-md-4 text-center animate-box">
					<a class="work" href="media.php">
						<div class="work-grid" style="background-image:url(images/diary.jpg);">
							<div class="inner">
								<div class="desc">
									<h3>Writing</h3>
									<span class="cat"></span>
				...
				<div class="col-md-4 text-center animate-box">
					<a class="work" href="media.php">
						<div class="work-grid" style="background-image:url(images/photo.jpg);">
							<div class="inner">
								<div class="desc">
									<h3>Pictures</h3>
									<span class="cat"></span>
