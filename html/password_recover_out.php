		...
		<div class="container">
            ...
            <!--NEW CODE BEGIN-->
                    ...
                    <div class="animate-box center">
                        <div>
                            <h4 class="fh5co-top-logo">A temporary password has been sent to your email account.</h4>
                        </div>
						<form action="#">
							<div class="row form-group">
								<div class="col-md-12">
									<label for="email">Password</label>
									<input type="text" id="email" class="form-control" placeholder="Enter Temporary Password">
                                </div>
							</div>
							<div class="form-group">
								<a href="login.php" class="btn btn-primary btn-outline">Login</a>
